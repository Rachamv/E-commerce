...
class ProductAdmin(admin.ModelAdmin):
    ...
    list_display = ['user', 'title', 'product_image', 'price',
                    'category', 'vendor', 'featured', 'product_status', 'pid']
...
class VendorAdmin(admin.ModelAdmin):
    list_display = ['user', 'title', 'vendor_image', 'vid']


class VendorReviewAdmin(admin.ModelAdmin):
    list_display = ['user', 'vendor', 'review', 'rating']
...
class AddressAdmin(admin.ModelAdmin):
    ...
    list_display = ['user', 'address', 'status', 'zipcode']
